  ...
  return (
    <div className={cc(['container', css.HomeInfo])}>
      ...
      <p className={cc([css.Intro, 'kr-text'])}>
        ...
        FEConf2019가 여러분을 찾아갑니다. 벌써 3년째를 맞이하며 대한민국 최고의 프론트엔드 개발자 컨퍼런스로 자리 잡고 있습니다. 올해는 오랜시간 준비하여 선정한 다양하고 풍부해진 14개의 발표 세션을 통해 프론트엔드를 개발하며 마주했던 치열한 고민과 깊은 인사이이트를 공유하며 여러분과 함께 성장하려고 합니다. <br/><br/>
